...
export class KeyboardInteractionHandlerService {
    ...
    constructor(private _camera: Camera, private _scene: Scene, ) {
        this._handlers.set(leftArrow, new LeftRotationHandler(this._camera, this._scene));
        this._handlers.set(rightArrow, new RightRotationHandler(this._camera, this._scene));
        this._handlers.set(upArrow, new UpRotationHandler(this._camera, this._scene));
        this._handlers.set(downArrow, new DownRotationHandler(this._camera, this._scene));
        this._handlers.set(shiftLeftArrow, new ShiftLeftRotationHandler(this._camera, this._scene));
        this._handlers.set(shiftRightArrow, new ShiftRightRotationHandler(this._camera, this._scene));
    }
